...
- It does not contain private infrastructure, database schema secrets, customer data, credentials, or deployment code

## Current Product Surfaces

- Managed website service for small and local businesses
- Client portal for account, billing history, support, tasks, and cloud storage
- Invite-only Krevo Cloud waitlist
